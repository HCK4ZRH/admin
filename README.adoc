...
* Confirm marketing material for the event. We prepared the following: marketing-ideas.adoc[tentative ideas for a logo], but probably we need to go for a more professional design.
